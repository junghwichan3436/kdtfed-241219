...
// test 일치하는지 일치하지 않는지 검사하는 역할을 한다
//문자로이루어진 숫자 123
// regexp.text("Hello");
// regexp.test("123");
...
// match라는 함수
// console.log(str.match(/ES6/)); //ES6 라는 패턴을 만든것!!
...
// const pattern = /^H/i;
// const pattern = /com$/i; 해당 문자열 이 이걸로 끝나냐 안 끝나냐 $
...
// const str = "ES2025";
// 숫자를 찾고싶다
// console.log(str.match(/[0-9]/g)); // 이패턴안에 어떤한범위를 지정하게되면 단순한 문자열이 아니라 배열의 형태로 반환한다
//범위앞에 캐럿이나오면 ~앞에 지만 범위 안으로 들어오면 0~9까지의 범위를 제외한 모든 요소를 찾아와라

// const str = "Ooooops";

// console.log(str.match(/o{2,4}/i));//2번이상이면서 4개까지인 문자를 찾아온다
// console.log(str.match(/o{2,}/i));//2번이상값을 찾아온다
